        ...
        if (isMorning) {
          ...
          const filterCounterExcludedTargets = (targets) => {
            ...
            return targets.filter(([r, c]) => {
              ...
              const shouldSkip = isCounterExcludedColor(color);
          ...
          regions = {
            nonAdjacent: filterCounterExcludedTargets(nonAdjacentRaw),
            capitalAdjacent: shuffle(filterCounterExcludedTargets(capitalAdjacentCells)),
            teamAdjacent: shuffle(filterCounterExcludedTargets(teamAdjacentCells)),
            mapEdge: shuffle(filterCounterExcludedTargets(mapEdgeCells)),
            onceMore: shuffle(filterCounterExcludedTargets(filteredCells(onceMoreCells)))
          };
