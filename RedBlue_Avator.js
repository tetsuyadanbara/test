          ...
          try {
            ...
            if (success) {
              if (currentProgress < 16) {
                nextProgress = Math.floor(Math.random() * 3) + 18;//18?20
               } else if (currentProgress < 33) {
                nextProgress = Math.floor(Math.random() * 3) + 35;//35?37
               } else if (currentProgress < 50) {
                nextProgress = Math.floor(Math.random() * 3) + 52;//52?54
               } else if (currentProgress < 66) {
                nextProgress = Math.floor(Math.random() * 3) + 68;//68?70
               } else if (currentProgress < 83) {
                nextProgress = Math.floor(Math.random() * 3) + 85;//85?87
               } else {
                nextProgress = Math.floor(Math.random() * 3) + 2;//2?4
               }
              next = `→ ${nextProgress}±1%`;
