          ...
          try {
            ...
            if (success) {
              if (currentProgress < 7) {
                nextProgress = Math.floor(Math.random() * 2) + 20;
               } else if (currentProgress < 24) {
                nextProgress = Math.floor(Math.random() * 2) + 37;
               } else if (currentProgress < 41) {
                nextProgress = Math.floor(Math.random() * 2) + 53;
               } else if (currentProgress < 57) {
                nextProgress = Math.floor(Math.random() * 2) + 70;
               } else if (currentProgress < 74) {
                nextProgress = Math.floor(Math.random() * 2) + 86;
               } else {
                nextProgress = Math.floor(Math.random() * 2) + 3;
               }
              next = `→ ${nextProgress}±2%`;
