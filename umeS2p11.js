...
(()=>{
  ...
  async function autoJoin() {
    ...
    function getRestrictedUmeRWindowInfo() {
      if (MODE === 'm=rb') {
        return { active: false, nextProgress: nextProgress };
      }
      if (currentProgress >= 48 && currentProgress <= 50) {
        return { active: true, nextProgress: 98 };
      }
      if (currentProgress >= 98 && currentProgress <= 100) {
        return { active: true, nextProgress: 48 };
      }
      if (currentProgress < 48) {
        return { active: false, nextProgress: 48 };
      }
      if (currentProgress < 98) {
        return { active: false, nextProgress: 98 };
      }
      return { active: false, nextProgress: 48 };
    }
