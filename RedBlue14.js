          ...
          try {
            ...
            if (success) {
              if (currentProgress < 10) {
                nextProgress = Math.floor(Math.random() * 2) + 23;//23～26±3
               } else if (currentProgress < 27) {
                nextProgress = Math.floor(Math.random() * 2) + 40;//40～43±3
               } else if (currentProgress < 44) {
                nextProgress = Math.floor(Math.random() * 2) + 56;//56～59±3
               } else if (currentProgress < 60) {
                nextProgress = Math.floor(Math.random() * 2) + 73;//73～76±3
               } else if (currentProgress < 77) {
                nextProgress = Math.floor(Math.random() * 2) + 89;//89～92±3
               } else {
                nextProgress = Math.floor(Math.random() * 2) + 6;//6～9±3
               }
              next = `→ ${nextProgress}±3%`;
