  ...
  async function autoJoin() {
    ...
    if (location.href.includes('/teambattle?m=rb')) {
      ...
      while(dialog.open) {
        ...
        if ((autoJoinMode === 'umeR' || ((autoJoinMode === 'counter' || autoJoinMode === 'lateCounter') && !stdCounterActive)) && !isMorningTime()) {
          autoJoinMode = 'stdP';
          ...
          logMessage(null, '[切替] umeR/counter/Late counter → stdP', '→ 時間終了');
