  ...
  (()=>{
    ...
    (()=>{
      ...
      function updateAutoJoinDialogPosition() {
        ...
        // 横並び用に十分な幅を確保
        // 目安: 62vw、ただし最大 1180px まで
        const preferredWidthPx = Math.min(Math.floor(window.innerWidth * 0.62), 1180);

        const heightPx = Math.max(260, window.innerHeight - topPx - bottomMargin);
      ...
      (()=>{
        ...
        previewWrap.style.margin = '2px';
        previewWrap.style.background = '#fff';
        previewWrap.style.minHeight = '220px';
        previewWrap.style.minWidth = '0';
        previewWrap.style.flex = '1 1 64%';
        ...
        previewCanvas.style.minHeight = '220px';
        ...
        log.style.minWidth = '260px';
        log.style.flex = '0 0 34%';
