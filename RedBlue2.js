...
(()=>{
  ...
  (()=>{
    ...
    (()=>{
      ...
      (()=>{
        ...
        previewFrame.classList.add('auto-join-preview-frame');
        previewFrame.style.width = '100%';
        previewFrame.style.flexGrow = '1';
        previewFrame.style.minHeight = '220px';
        previewFrame.style.border = 'none';
        previewFrame.style.background = '#fff';
        previewFrame.referrerPolicy = 'same-origin';
        previewFrame.src = location.pathname + location.search;

        previewHeader.append(previewTitle, previewStatus);
        previewWrap.append(previewHeader, previewFrame);
  ...
  function refreshAutoJoinPreview(force = false) {
    const dialog = document.querySelector('.auto-join');
    const frame = document.querySelector('.auto-join-preview-frame');
    if (!frame) return;
