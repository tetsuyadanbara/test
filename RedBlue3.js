...
(()=>{
  ...
  (()=>{
    ...
    (()=>{
      ...
      (()=>{
        ...
        previewWrap.append(previewHeader, previewCanvas);
  ...
  function refreshAutoJoinPreview(force = false) {
    ...
    const fog = document.getElementById('gridFog');
    const overlay = document.getElementById('gridOverlay');

    if (!base || !overlay) {
      setAutoJoinPreviewStatus('元盤面が見つかりません');
      return;
    }
    ...
    if (!width || !height) {
      setAutoJoinPreviewStatus('盤面描画待ち');
      return;
    }
    ...
    if (!ctx) {
      setAutoJoinPreviewStatus('preview描画失敗');
      return;
    }
