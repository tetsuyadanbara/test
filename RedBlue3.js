  ...
  async function autoJoin() {
    ...
    async function executeStep(region, options = {}) {
      ...
      if (messageType === 'equipError') {
        ...
        return { ok: false, stop: false, retry: false, stale: false, defeated: false, waitSeconds: 0, message: lastLine };
      }
      if (
        messageType === 'reset' ||
        ...
        if (result.defeated) {
          ...
          if (ownCapital) {
            ...
            if (redeployResult.stop) {
              return { moved: false, stop: true, keepWatching: false, waitSeconds: 0, message: redeployResult.message };
            }
