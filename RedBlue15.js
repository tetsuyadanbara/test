...
(()=>{
  ...
  function detectSelfAvatar(avatars) {
    ...
    if (avatars.myAvatar && typeof avatars.myAvatar === 'object') {
      return avatars.myAvatar;
    }
    if (avatars.selfAvatar && typeof avatars.selfAvatar === 'object') {
      return avatars.selfAvatar;
    }
    if (Array.isArray(avatars.avatars)) {
      const tagged = avatars.avatars.find(av =>
        av && (av.isSelf === true || av.self === true || av.mine === true)
      );
