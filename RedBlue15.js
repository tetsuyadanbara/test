...
(()=>{
  ...
  function readLiveBattleStateFromPage() {
    ...
    if (avatars && avatars.myAvatar) {
      myAvatar = {
        r: Number(avatars.myAvatar.row),
        c: Number(avatars.myAvatar.col)
      };
      myTeam = avatars.myAvatar.team || '';
    } else if (avatars && avatars.selfAvatar) {
      myAvatar = {
        r: Number(avatars.selfAvatar.row),
        c: Number(avatars.selfAvatar.col)
      };
      myTeam = avatars.selfAvatar.team || '';
    }
  ...
  async function autoJoinCanvasTick() {
    ...
    try {
      ...
      const target = tiles.adjacentEnemy[0] || tiles.adjacentOther[0];
