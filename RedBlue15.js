...
(()=>{
  ...
  function readLiveBattleStateFromPage() {
    ...
    let myAvatar = liveTileState.confirmedMyAvatar
      ? { ...liveTileState.confirmedMyAvatar }
      : null;
  ...
  function renderAvatarMarkersOnCustomCells() {
    ...
    const self = liveTileState.confirmedMyAvatar
      ? { ...liveTileState.confirmedMyAvatar }
      : (liveTileState.myAvatar ? { ...liveTileState.myAvatar } : null);
  ...
  async function arenaChallenge (row, col){
    ...
    try {
      ...
      liveTileState.confirmedMyAvatar = { r: Number(row), c: Number(col) };
