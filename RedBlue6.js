  ...
  async function autoJoin() {
    ...
    async function runAutoBattleLoop() {
      ...
      for (let loop = 0; loop < 100; loop++) {
        ...
        const rbRefreshWaitKey = getAutoJoinRBRefreshWaitKey(currentProgress);
        if (rbRefreshWaitKey && lastAutoJoinRBRefreshWaitKey !== rbRefreshWaitKey) {
          lastAutoJoinRBRefreshWaitKey = rbRefreshWaitKey;
          return {
            acted: false,
            stop: false,
            keepWatching: true,
