          ...
          try {
            ...
            if (success) {
              if (currentProgress < 10) {
                nextProgress = Math.floor(Math.random() * 2) + 23;
               } else if (currentProgress < 27) {
                nextProgress = Math.floor(Math.random() * 2) + 40;
               } else if (currentProgress < 44) {
                nextProgress = Math.floor(Math.random() * 2) + 56;
               } else if (currentProgress < 60) {
                nextProgress = Math.floor(Math.random() * 2) + 73;
               } else if (currentProgress < 77) {
                nextProgress = Math.floor(Math.random() * 2) + 89;
               } else {
                nextProgress = Math.floor(Math.random() * 2) + 6;
               }
              next = `→ ${nextProgress}±5%`;
